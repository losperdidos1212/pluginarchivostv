...
class iptv_streamse():
    ...
    def read_config(self):
        try:
            tree = ElementTree()
            xml = tree.parse('/usr/lib/enigma2/python/Plugins/Extensions/archivostv/nStreamConfig.xml')
    ...
    def get_list(self, url = None, send_mac = True):
        ...
        try:
            if url == 'playlist_history':
                ...
                tree = ElementTree()
                if self.server_oki:
                    xml = tree.parse('/usr/lib/enigma2/python/Plugins/Extensions/archivostv/nStreamFavorites.xml')
    ...
    def write_favorites(self):
        ...
        if self.server_oki:
            try:
                fileObj = open('/usr/lib/enigma2/python/Plugins/Extensions/archivostv/nStreamFavorites.xml', 'w')
